...
2.move_ghost: this function will be used to move the ghosts at random
3.eat_pellet: this function will be used to increase the score of the player and to remove a pellet from the game